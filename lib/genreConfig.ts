// Single source of truth for genre normalization.
// Imported by lib/genres.ts, web/lib/genres.ts, web/lib/genreFamily.ts, and lib/claudeGenres.ts.
// Edit only here — never in the consuming files.
