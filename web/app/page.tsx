...
export default async function HomePage() {
  ...
  const langHeader = h.get("x-lang") ?? DEFAULT_LANG;
  const lang = (LANGS.includes(langHeader as Lang) ? langHeader : DEFAULT_LANG) as Lang;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-30 border-b border-[var(--border)] bg-[var(--background)]/90 backdrop-blur-sm">
        <div className="max-w-3xl mx-auto px-5 pr-2.5 h-14 flex items-center justify-between">
